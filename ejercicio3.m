...
fprintf('Hospital A -> bajo riesgo: %.1f%%, alto riesgo: %.1f%%, global: %.1f%%\n', tasa_A_bajo, tasa_A_alto, tasa_A_global);
fprintf('Hospital B -> bajo riesgo: %.1f%%, alto riesgo: %.1f%%, global: %.1f%%\n', tasa_B_bajo, tasa_B_alto, tasa_B_global);